...
MainWindow::MainWindow(QWidget *parent) //вызов виджета
    : QMainWindow(parent)
    , ui(new Ui::MainWindow)
{
    ui->setupUi(this);

    connect(ui->pushButton_0,SIGNAL(released()),this,SLOT(digit_pressed())); //14-23 кнопки 0-9
    ...
    connect(ui->pushButton_multiply,SIGNAL(released()),this,SLOT(binary_operation_pressed())); //(х)
...
void MainWindow::on_pushButton_clear_released() //Кнопка С
{
...
void MainWindow::on_pushButton_equals_released() //Кнопка =
{
